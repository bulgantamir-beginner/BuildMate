...
const SPEC_FIELDS = {
  cpu: [
    ...
    { key: "cache", label: "Cache", placeholder: "32MB L3" },
    {
      key: "architecture",
      label: "Architecture",
      placeholder: "Zen 4, Raptor Lake",
    },
    {
      key: "integratedGraphics",
      label: "Integrated Graphics",
      placeholder: "Radeon 780M / байхгүй",
    },
    { key: "memoryType", label: "RAM Төрөл", placeholder: "DDR5, DDR4" },
    {
      key: "maxMemory",
      label: "Хамгийн их RAM (GB)",
      type: "number",
      placeholder: "128",
    },
    {
  ...
  gpu: [
    ...
    },
    {
      key: "type",
      label: "VRAM Төрөл",
      placeholder: "GDDR6X, GDDR6, GDDR7",
      required: true,
    },
    {
      key: "tdp",
    ...
    {
      key: "powerConnectors",
      label: "Цахилгааны Холбоос",
      placeholder: "1x 16-pin / 2x 8-pin",
    },
  ...
  storage: [
    ...
    },
    {
      key: "interface",
      label: "Interface",
      placeholder: "M.2 PCIe 4.0, SATA III",
      required: true,
    },
    {
      key: "readSpeed",
      label: "Унших Хурд (MB/s)",
      type: "number",
      placeholder: "7000",
      required: true,
    },
  ...
  psu: [
    ...
    },
    {
      key: "efficiency",
      label: "Efficiency",
      placeholder: "80+ Gold, 80+ Platinum",
      required: true,
    },
    {
      key: "modular",
      label: "Modular",
      placeholder: "Fully / Semi / Non-Modular",
    },
    { key: "formFactor", label: "Form Factor", placeholder: "ATX, SFX" },
    {
      key: "fanSize",
      label: "Сэнсний хэмжээ (mm)",
      type: "number",
      placeholder: "135",
    },
    {
      key: "pciePins",
      label: "12VHPWR / PCIe Pin",
      placeholder: "1x 16-pin, 4x 6+2-pin",
    },
    {
      key: "sataConnectors",
      label: "SATA Connector тоо",
      type: "number",
      placeholder: "8",
    },
    {
  ...
  cooler: [
    {
      key: "type",
      label: "Cooler Төрөл",
      placeholder: "Air / 240mm AIO / 360mm AIO",
      required: true,
    },
    {
      key: "compatibleSockets",
      label: "Тохирох Socket-үүд",
      placeholder: "AM4,AM5,LGA1700 (таслалаар)",
      required: true,
    },
    {
      key: "tdpSupport",
      label: "Дэмжих TDP (Watt)",
      type: "number",
      placeholder: "250",
      required: true,
    },
  ...
  case: [
    {
      key: "formFactor",
      label: "Дэмжих Form Factor",
      placeholder: "ATX,mATX,ITX (таслалаар)",
      required: true,
    },
    {
      key: "type",
      label: "Кейсийн Төрөл",
      placeholder: "Full Tower / Mid Tower / Mini-ITX",
    },
    {
      key: "maxGpuLength",
      label: "GPU-ийн хамгийн их урт (мм)",
      type: "number",
      placeholder: "420",
    },
    {
      key: "maxCoolerHeight",
      label: "Cooler-ийн хамгийн их өндөр (мм)",
      type: "number",
      placeholder: "170",
    },
    {
      key: "maxPsuLength",
      label: "PSU-ийн хамгийн их урт (мм)",
      type: "number",
      placeholder: "200",
    },
    {
      key: "driveBays35",
      label: '3.5" Drive Bay тоо',
      type: "number",
      placeholder: "2",
    },
    {
      key: "driveBays25",
      label: '2.5" Drive Bay тоо',
      type: "number",
      placeholder: "4",
    },
    {
      key: "frontFanSlots",
      label: "Урд Сэнсний Slot",
      placeholder: "3x 120mm / 2x 140mm",
    },
    { key: "topFanSlots", label: "Дээд Сэнсний Slot", placeholder: "2x 120mm" },
    { key: "rearFanSlots", label: "Ар Сэнсний Slot", placeholder: "1x 120mm" },
    {
      key: "maxRadiatorSupport",
      label: "AIO Radiator Дэмжих",
      placeholder: "360mm",
    },
    {
      key: "frontIo",
      label: "Урд I/O",
      placeholder: "USB-C 3.2, 2x USB-A, Аудио",
    },
    {
      key: "material",
      label: "Материал",
      placeholder: "Steel + Tempered Glass",
    },
    {
      key: "sidePanelType",
      label: "Хажуу Хавтан",
...
export default function AdminPage() {
  const [authed, setAuthed] = useState(
    () => sessionStorage.getItem("bm-admin") === "true",
  );
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      setLoginErr("Нэвтрэх нэр эсвэл нууц үг буруу байна");
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      (SPEC_FIELDS[form.category] || []).forEach(({ key }) => {
        if (specForm[key] !== undefined && specForm[key] !== "")
          fd.append(key, specForm[key]);
      });
      if (editId) {
        await updatePart(editId, fd);
        showMsg("Амжилттай шинэчлэгдлэа!");
      } else {
        await createPart(fd);
        showMsg("Шинэ эд анги нэмэгдлэа!");
      }
      resetForm();
      setTab("list");
      loadParts();
      ...
      showMsg(
        "Алдаа: " + (err.response?.data?.message || err.message),
        "error",
      );
    }
    setLoading(false);
  ...
  const HINTS = {
    ...
    motherboard:
      "Socket нь CPU-тэй таарах ёстой · Z790/X670/B650 → DDR5 · B550/Z590 → DDR4\nChipset: Intel → Z790/B760/H610, AMD → X670E/X670/B650/A520",
    ...
    cooler:
      "Socket: AM4,AM5,LGA1700 гэж таслалаар тусгаарла\nTDP дэмжих: CPU TDP-ээс 25-50W их байх хэрэгтэй",
    storage:
      "NVMe PCIe 4.0: 7000 MB/s унших · SATA SSD: 550 MB/s · HDD: 150 MB/s\nInterface заавал бичнэ — nийцлийн шалгалтад ашиглана",
        ...
        >
          <div style={{ textAlign: "center", marginBottom: 28 }}>
            ...
            >
              <span
                ...
                style={{ color: "var(--accent-light)", fontSize: 26 }}
              >
                admin_panel_settings
              </span>
            </div>
            <div
              style={{ fontSize: 20, fontWeight: 900, color: "var(--text)" }}
            >
              Админ нэвтрэх
            </div>
            <div
          ...
          <form onSubmit={handleLogin}>
            ...
            <div style={{ marginBottom: 14 }}>
              <label style={LS}>Нэвтрэх нэр</label>
              <input
                value={loginUser}
    ...
    <div style={{ padding: 24, maxWidth: 1100, margin: "0 auto" }}>
      ...
      {msg && (
        <div
          style={{
            background:
              msgType === "success" ? "var(--green-dim)" : "var(--red-dim)",
            border: `1px solid ${msgType === "success" ? "var(--green)" : "var(--red)"}30`,
            borderRadius: 10,
            padding: "10px 16px",
            fontSize: 13,
      ...
      >
        {[
          { id: "list", label: "Жагсаалт", icon: "list" },
          {
            id: "form",
            label: editId ? "Засах" : "Нэмэх",
            icon: editId ? "edit" : "add_circle",
          },
        ].map((t) => (
          <button
            key={t.id}
            ...
            style={{
              ...
              color:
                tab === t.id ? "var(--accent-light)" : "var(--text-secondary)",
            }}
          >
            ...
            {CATEGORIES.map((c) => (
              <button
                ...
                style={{
                  ...
                  fontSize: 12,
                  fontWeight: 600,
                  border: `1px solid ${filterCat === c.id ? "var(--accent)" : "var(--border)"}`,
                  background:
                    filterCat === c.id
                      ? "var(--accent-dim)"
                      : "var(--bg-elevated)",
          ...
          {loading ? (
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              {parts.length === 0 && (
                ...
                >
                  Эд анги байхгүй байна. Шинэ нэмнэ үү.
                </div>
              )}
              {parts.map((p) => (
                <div
        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            ...
            >
              ...
              <div style={{ marginBottom: 13 }}>
                <label style={LS}>Зэрэглэл *</label>
                <select {...ff("tier")} style={IS}>
                  {TIERS.map((t) => (
              ...
              <div>
                <label style={LS}>Зураг (сонголтоор)</label>
                <input
                  type="file"
                  accept="image/*"
                  onChange={(e) =>
